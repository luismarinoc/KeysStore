...
import { Project } from '@keysstore/shared-types';
        ...
        <View style={[styles.card, { width: cardWidth }]}>
            ...
            >
                ...
                <View style={styles.textContainer}>
                    ...
                    <Text style={styles.subtitle}>Creado: {item.created_at ? new Date(item.created_at).toLocaleDateString('es-ES') : 'N/A'}</Text>
                </View>
